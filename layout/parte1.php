...
<head>
  ...
  <!-- Librería Sweetalert2 (INSTALADA PARA PODERSE MOSTRAR MENSAJES LLAMATIVOS-->
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

  <!--CÓDIGO INCORPORADO: public/templates/AdminLTE/pages/tables/data.html -->
  <!-- DataTables -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!--AGREGAMOS ESTE TÍTULO PARA Q APAREZCA EN LA MISMA BARRA -->  
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">SISTEMA DE VENTAS</a>
      </li>
    </ul>

    <!-- Right navbar links (LINKS LADO DERECHO DE LA BARRA DE NAVEGACIÓN) -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>" class="brand-link">
      <img src="<?php echo $URL;?>/public/images/sistventas1.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
