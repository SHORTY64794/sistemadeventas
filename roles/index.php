        ...
        <div class="col-md-8">
          <div class="card card-outline card-primary">
            ...
            <div class="card-body" style="display:block">
              <table id="listado_roles" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>
                      <center>Nro</center>
  ...
  $(function () {
    $("#listado_roles").DataTable({
      ...
      "language": {
        ...
        "infoEmpty": "Mostrando de 0 a 0 de un total de 0 Roles",
    ...
    }).buttons().container().appendTo('#listado_roles_wrapper .col-md-6:eq(0)');
  });
</script>
